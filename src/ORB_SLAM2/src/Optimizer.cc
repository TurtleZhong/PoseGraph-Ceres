...
//         << endl << "And it will perform 4 optimizations. Here we show the times of each optimization:" << endl;
    ...
    for(size_t it=0; it<4; it++)
    {
        ...
        for(size_t i=0, iend=vpEdgesStereo.size(); i<iend; i++)
        {
            ...
            {
                pFrame->mvbOutlier[idx]=true; /*outliers*/
                e->setLevel(1);
                nBad++;
            }
            else
            {                
                e->setLevel(0);
                pFrame->mvbOutlier[idx]=false; /*inliers*/
            }
    ...
    cout << BOLDGREEN << pFrame->mnId << " : inliers = " << nInitialCorrespondences-nBad << endl;
...
//    cout << RED"**************************" << endl;
//    cout << "**************************" << endl;
//    cout << "**Local BundleAdjustment**" << endl;
//    cout << "**************************" << endl;
//    cout << "**************************" << endl;
    //cout << "Frame: " << pKF->mnId << endl;
    optimizer.initializeOptimization();
    optimizer.optimize(10);//origin 5
